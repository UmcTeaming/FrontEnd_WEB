...
import OPjBoxes from "../../components/OngoingProjectComponents/OngoingProjectBoxType/opjBoxes.js";
import OPjLines from "../../components/OngoingProjectComponents/OngoingProjectLineType/opjLines.js";
...
export const OngoingProject = () => {
    ...
    useEffect(() => {
      axios.get("/datas/progressProjects.json")
          .then((response) => {
              console.log(response);
              setOngoingProjects(response.data.data.portfolio);
          })
          .catch((error) => {
      ...
      axios
          ...
          .then((response) => {
              setOngoingProjects(prevProjects => [...prevProjects, ...response.data.data.portfolio]);
              console.log(response);
          })
          .catch((error) => {
              console.error("Error fetching portfolio data:", error);
            ...
            <div className="temp">
              <div className="component">
                ...
                <div className="Name opname">
                  <br />
                  <br />
                  <span className="userName opusername">{nickName}님의 포트폴리오</span>
                  <br />
              ...
              <div className="element">
                <div className="list">
                  ...
                  {viewBox ? <OPjBoxes projects={ongoingProjects} /> : <OPjLines projects={ongoingProjects} />}
                </div>
              </div>
            </div>
          </div>
